...
exports.EntitiesJsonPostgresPersistence = void 0;
/** @module persistence */
const pip_services3_commons_nodex_1 = require("pip-services3-commons-nodex");
const pip_services3_postgres_nodex_1 = require("pip-services3-postgres-nodex");
class EntitiesJsonPostgresPersistence extends pip_services3_postgres_nodex_1.IdentifiableJsonPostgresPersistence {
    constructor() {
        super('entities_json');
    ...
    getOneByName(correlationId, name) {
        return __awaiter(this, void 0, void 0, function* () {
            let query = "SELECT * FROM " + this.quoteIdentifier(this._tableName) + " WHERE data->>'name'=$1";
            let params = [name];
...
exports.EntitiesJsonPostgresPersistence = EntitiesJsonPostgresPersistence;
//# sourceMappingURL=EntitiesJsonPostgresPersistence.js.map