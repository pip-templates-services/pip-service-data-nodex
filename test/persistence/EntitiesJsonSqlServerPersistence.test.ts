...
import { EntitiesJsonSqlServerPersistence } from '../../src/persistence/EntitiesJsonSqlServerPersistence';
import { EntitiesPersistenceFixture } from './EntitiesPersistenceFixture';

suite('EntitiesJsonSqlServerPersistence', () => {
    let persistence: EntitiesJsonSqlServerPersistence;
    ...
    setup(async () => {
        persistence = new EntitiesJsonSqlServerPersistence();
